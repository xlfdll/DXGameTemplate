...
void PrintText(LPD3DXFONT font, wstring text, LONG x, LONG y, D3DCOLOR color)
{
	RECT rect = { x, y, 0, 0 };
...
void PrintText(LPD3DXFONT font, wstring text, RECT rect, DWORD format, D3DCOLOR color)
{
